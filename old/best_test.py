...
parser.add_argument("--path", type=str, default="data/processor-ckpt/best/best_noise_0_600_.pkl")
...
def main():
    ...
    for i, (imgs, _) in enumerate(test_loader):
        ...
        print("i: {}\nprob1: {}, prob2: {}\nloss: {}, ssim: {}".format(
            i, prob1.mean(), prob2.mean(), loss.item(), ssim))
        if i % 10 == 0:
            wind.images(imgs.cpu(), win="imgs")
            wind.images(p_imgs.cpu(), win="p_imgs")
            wind.images(noise.cpu(), win="noise")
