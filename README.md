...
# Update
**_2023.10.7_**  
1. The open source data([see here](https://genimage-dataset.github.io/)) set was used to train its own detector, and the noise processing network model trained on this data set had a dramatic excellent effect.
